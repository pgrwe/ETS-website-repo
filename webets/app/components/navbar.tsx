...
export default function NavBar() {
  ...
  return (
    <nav 
      className= {`p-4 ${menu ? 'bg-custom-200 border-b-[1px] border-e6palette-200' : 'bg-transparent'} fixed w-screen flex 
      ...
      <DropdownMenu.Root onOpenChange={setMenu}>
        ...
        {menu && (
          <DropdownMenu.Portal forceMount>
            ...
            exit={{ opacity: 0}}
            >
              <DropdownMenu.Item className='w-full h-full' >3D Printing</DropdownMenu.Item>
